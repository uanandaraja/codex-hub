<script lang="ts">
	...
	const closeButtonClass =
		'inline-flex h-7 w-7 items-center justify-center border-0 bg-transparent text-fg transition-[background,border-color,color] duration-150 hover:text-accent disabled:cursor-default disabled:opacity-[0.45]';
...
>
	<div
		class="flex min-h-[3rem] min-w-0 items-center justify-between gap-1 rounded-none border-b border-line px-[0.6rem] py-[0.38rem]"
	>
		<button
			type="button"
		...
		>
			<h1 class="truncate text-[0.68rem] font-medium uppercase tracking-[0.16em] text-muted">
				Codex Hub
			</h1>
		</button>
